...
<body>
    <main>
        <div class="container">
            ...
            <div class="card mb-3">
                <div class="card-header"><i class="fas fa-cube"></i> Instructor investigador</div>
                <div class="card-body">
                    <form action="{{ url('diagnostico') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" style="width: 100%" name="id_persona" id="id_persona">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{ url("diagnostico/{$empresa->nit}/mision") }}" method="post">
                        @csrf
                        @method('PUT')
                        <p class="form-control" name="mision" id="mision">{{ $exist_diagnostico_empresa->mision }}</p>
                    </form>
                </div>
            </div>
            <!--Visión empresa-->
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{ url("diagnostico/{$empresa->nit}/vision") }}" method="post">
                        @csrf
                        @method('PUT')
                        <p class="form-control" name="vision" id="vision">{{ $exist_diagnostico_empresa->vision }}</p>
                    </form>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{ url("diagnostico/{$empresa->nit}/objestrategico") }}" method="post">
                        @csrf
                        @method('PUT')
                        <p class="form-control" name="objestrategico"
                            id="objestrategico">{{ $exist_diagnostico_empresa->objetivo_estrategio }}</p>
                    </form>
                </div>
            </div>
            <!--Fin a todos-->
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url("diagnostico/{$empresa->nit}/perspectivacrecimientodesarrollo") }}"
                        ...
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd1"
                                id="preguntacd1">{{ $exist_diagnostico_empresa->preguntacd1 }}</p>
                        </div>
                        <!--pregunta1.1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd1_1"
                                id="preguntacd1_1">{{ $exist_diagnostico_empresa->preguntacd1_1 }}</p>
                        </div>
                        <!--pregunta2-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd2"
                                id="preguntacd2">{{ $exist_diagnostico_empresa->preguntacd2 }}</p>
                        </div>
                        ...
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd3"
                                id="preguntacd3">{{ $exist_diagnostico_empresa->preguntacd3 }}</p>
                        </div>
                        <!--pregunta4-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd4"
                                id="preguntacd4">{{ $exist_diagnostico_empresa->preguntacd4 }}</p>
                        </div>
                        <!--pregunta5-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd5"
                                id="preguntacd5">{{ $exist_diagnostico_empresa->preguntacd5 }}</p>
                        </div>
                        <!--pregunta5.1-->
                        <div class="alert alert-light">
                            <p>5.1 Si su respuesta anterior fue SI, señale ¿Cuantos?</p>
                            <p>Respuesta: {{ $empresa->pre5_1_pcd }}</p>
                            <p class="form-control" name="preguntacd5_1"
                                id="preguntacd5_1">{{ $exist_diagnostico_empresa->preguntacd5_1 }}</p>
                        </div>
                        <!--pregunta6-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd6"
                                id="preguntacd6">{{ $exist_diagnostico_empresa->preguntacd6 }}</p>
                        </div>
                        <!--pregunta7-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd7"
                                id="preguntacd7">{{ $exist_diagnostico_empresa->preguntacd7 }}</p>
                        </div>
                        <!--pregunta8-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd8"
                                id="preguntacd8">{{ $exist_diagnostico_empresa->preguntacd8 }}</p>
                        </div>
                        <!--pregunta9-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd9"
                                id="preguntacd9">{{ $exist_diagnostico_empresa->preguntacd9 }}</p>
                        </div>
                        <!--pregunta10-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd10"
                                id="preguntacd10">{{ $exist_diagnostico_empresa->preguntacd10 }}</p>
                        </div>
                        <!--pregunta11-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd11"
                                id="preguntacd11">{{ $exist_diagnostico_empresa->preguntacd11 }}</p>
                        </div>
                        <!--pregunta12-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd12"
                                id="preguntacd12">{{ $exist_diagnostico_empresa->preguntacd12 }}</p>
                        </div>
                        <!--pregunta13-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd13"
                                id="preguntacd13">{{ $exist_diagnostico_empresa->preguntacd13 }}</p>
                        </div>
                        <!--pregunta14-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd14"
                                id="preguntacd14">{{ $exist_diagnostico_empresa->preguntacd14 }}</p>
                        </div>
                        <!--pregunta15-->
                        <div class="alert alert-light">
                            <p>15. ¿En que ha estado representada esta compensación?</p>
                            <p>Respuesta: {{ $empresa->pre15_pcd }}</p>
                            <p class="form-control" name="preguntacd15"
                                id="preguntacd15">{{ $exist_diagnostico_empresa->preguntacd15 }}</p>
                        </div>
                        <!--pregunta16-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd16"
                                id="preguntacd16">{{ $exist_diagnostico_empresa->preguntacd16 }}</p>
                        </div>
                        <!--pregunta17-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd17"
                                id="preguntacd17">{{ $exist_diagnostico_empresa->preguntacd17 }}</p>
                        </div>
                        <!--pregunta7-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntacd17_1"
                                id="preguntacd17_1">{{ $exist_diagnostico_empresa->preguntacd17_1 }}</p>
                        </div>
                    </form>
                    <hr>
                    <!--Fin-->
                    ...
                    <form action="{{ url("diagnostico/{$empresa->nit}/perspectivacliente") }}" method="post">
                        ...
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac1"
                                id="preguntac1">{{ $exist_diagnostico_empresa->preguntac1 }}</p>
                        </div>
                        <!--preguntapc2-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac2"
                                id="preguntac2">{{ $exist_diagnostico_empresa->preguntac2 }}</p>
                        </div>
                        <!--preguntapc3-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac3"
                                id="preguntac3">{{ $exist_diagnostico_empresa->preguntac3 }}</p>
                        </div>
                        <!--preguntapc4-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac4"
                                id="preguntac4">{{ $exist_diagnostico_empresa->preguntac4 }}</p>
                        </div>
                        <!--preguntapc4.1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac4_1"
                                id="preguntac4_1">{{ $exist_diagnostico_empresa->preguntac4_1 }}</p>
                        </div>
                        <!--preguntapc5-->
                        <div class="alert alert-light">
                            <p>5. ¿En qué porcentaje ha crecido el número de clientes de su negocio?</p>
                            <p>Respuesta: {{ $empresa->pre5_pc }}</p>
                            <p class="form-control" name="preguntac5"
                                id="preguntac5">{{ $exist_diagnostico_empresa->preguntac5 }}</p>
                        </div>
                        <!--preguntapc6-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac6"
                                id="preguntac6">{{ $exist_diagnostico_empresa->preguntac6 }}</p>
                        </div>
                        <!--preguntapc7-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac7"
                                id="preguntac7">{{ $exist_diagnostico_empresa->preguntac7 }}</p>
                        </div>
                        <!--preguntapc8-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac8"
                                id="preguntac8">{{ $exist_diagnostico_empresa->preguntac8 }}</p>
                        </div>
                        <!--preguntapc9-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntac9"
                                id="preguntac9">{{ $exist_diagnostico_empresa->preguntac9 }}</p>
                        </div>
                    </form>
                    <hr>
                    <!--Fin-->
                    ...
                    <form action="{{ url("diagnostico/{$empresa->nit}/perspectivaprocesosinternos") }}"
                        ...
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi1"
                                id="preguntapi1">{{ $exist_diagnostico_empresa->preguntapi1 }}</p>
                        </div>
                        <!--preguntappi2-->
                        <div class="alert alert-light">
                            <p>2. ¿La empresa tiene documentados sus procesos internos?</p>
                            <p>Respuesta: {{ $empresa->pre2_pi }}</p>
                            <p class="form-control" name="preguntapi2"
                                id="preguntapi2">{{ $exist_diagnostico_empresa->preguntapi2 }}</p>
                        </div>
                        <!--preguntappi3-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi3"
                                id="preguntapi3">{{ $exist_diagnostico_empresa->preguntapi3 }}</p>
                        </div>
                        <!--preguntappi3.1-->
                        <div class="alert alert-light">
                            <p>3.1 Si su respuesta a la anterior pregunta fue SI, mencione ¿Cual?</p>
                            <p>Respuesta: {{ $empresa->pre3_2_pi }}</p>
                            <p class="form-control" name="preguntapi3_1"
                                id="preguntapi3_1">{{ $exist_diagnostico_empresa->preguntapi3_1 }}</p>
                        </div>
                        <!--preguntappi4-->
                        <div class="alert alert-light">
                            <p>4. ¿La empresa cuenta con alguna certificación de Calidad?</p>
                            <p>Respuesta: {{ $empresa->pre4_1_pi }}</p>
                            <p class="form-control" name="preguntapi4"
                                id="preguntapi4">{{ $exist_diagnostico_empresa->preguntapi4 }}</p>
                        </div>
                        <!--preguntappi4_1-->
                        <div class="alert alert-light">
                            <p>4.1 Si su respuesta a la anterior pregunta fue SI, mencione ¿Cual?</p>
                            <p>Respuesta: {{ $empresa->pre4_2_pi }}</p>
                            <p class="form-control" name="preguntapi4_1"
                                id="preguntapi4_1">{{ $exist_diagnostico_empresa->preguntapi4_1 }}</p>
                        </div>
                        <!--preguntappi5-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi5"
                                id="preguntapi5">{{ $exist_diagnostico_empresa->preguntapi5 }}</p>
                        </div>
                        <!--preguntappi6-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi6"
                                id="preguntapi6">{{ $exist_diagnostico_empresa->preguntapi6 }}</p>
                        </div>
                        <!--preguntappi6_1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi6_1"
                                id="preguntapi6_1">{{ $exist_diagnostico_empresa->preguntapi6_1 }}</p>
                        </div>
                        <!--preguntappi7-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi7"
                                id="preguntapi7">{{ $exist_diagnostico_empresa->preguntapi7 }}</p>
                        </div>
                        <!--preguntappi8-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapi6_1"
                                id="preguntapi8">{{ $exist_diagnostico_empresa->preguntapi8 }}</p>
                        </div>
                    </form>
                    <hr>
                    <!--Fin-->
                    ...
                    <form action="{{ url("diagnostico/{$empresa->nit}/perspectivafinanciera") }}" method="post">
                        ...
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf1"
                                id="preguntapf1">{{ $exist_diagnostico_empresa->preguntapf1 }}</p>
                        </div>
                        <!--preguntapf_1.1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf1_1"
                                id="preguntapf1_1">{{ $exist_diagnostico_empresa->preguntapf1_1 }}</p>
                        </div>
                        <!--preguntapf2-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf2"
                                id="preguntapf2">{{ $exist_diagnostico_empresa->preguntapf2 }}</p>
                        </div>
                        <!--preguntapf2.1-->
                        <div class="alert alert-light">
                            <p>2.1 Si su respuesta a la anterior pregunta fue SI, mencione ¿Cual?</p>
                            <p>Respuesta: {{ $empresa->pre2_1_pf }}</p>
                            <p class="form-control" name="preguntapf2_1"
                                id="preguntapf2_1">{{ $exist_diagnostico_empresa->preguntapf2_1 }}</p>
                        </div>
                        <!--preguntapf3-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf3"
                                id="preguntapf3">{{ $exist_diagnostico_empresa->preguntapf3 }}</p>
                        </div>
                        <!--preguntapf3_1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf3_1"
                                id="preguntapf3_1">{{ $exist_diagnostico_empresa->preguntapf3_1 }}</p>
                        </div>
                        <!--preguntapf4-->
                        <div class="alert alert-light">
                            <p>4. Su empresa lleva Contabilidad de:</p>
                            <p>Respuesta: {{ $empresa->pre4_pf }}</p>
                            <p class="form-control" name="preguntapf4"
                                id="preguntapf4">{{ $exist_diagnostico_empresa->preguntapf4 }}</p>
                        </div>
                        <!--preguntapf5-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf5"
                                id="preguntapf5">{{ $exist_diagnostico_empresa->preguntapf5 }}</p>
                        </div>
                        <!--preguntapf6-->
                        <div class="alert alert-light">
                            <p>6. ¿La empresa realiza control mensual de sus costos y gastos?</p>
                            <p>Respuesta: {{ $empresa->pre6_pf }}</p>
                            <p class="form-control" name="preguntapf6"
                                id="preguntapf6">{{ $exist_diagnostico_empresa->preguntapf6 }}</p>
                        </div>
                        <!--preguntapf7-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf7"
                                id="preguntapf7">{{ $exist_diagnostico_empresa->preguntapf7 }}</p>
                        </div>
                        <!--preguntapf8-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf8"
                                id="preguntapf8">{{ $exist_diagnostico_empresa->preguntapf8 }}</p>
                        </div>
                        <!--preguntapf9-->
                        <div class="alert alert-light">
                            <p>9. ¿Tiene usted conocimiento de que son los Indicadores financieros?</p>
                            <p>Respuesta: {{ $empresa->pre9_1_pf }}</p>
                            <p class="form-control" name="preguntapf9"
                                id="preguntapf9">{{ $exist_diagnostico_empresa->preguntapf9 }}</p>
                        </div>
                        <!--preguntapf9_1-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf9_1"
                                id="preguntapf9_1">{{ $exist_diagnostico_empresa->preguntapf9_1 }}</p>
                        </div>
                        <!--preguntapf10-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf10"
                                id="preguntapf10">{{ $exist_diagnostico_empresa->preguntapf10 }}</p>
                        </div>
                        <!--preguntapf10_1  -->
                        <div class="alert alert-light">
                            <p>10.1 Si respondió Sí a la anterior pregunta ¿Mencione qué montos?</p>
                            <p>Respuesta: $ {{ $empresa->pre10_2_pf }}</p>
                            <p class="form-control" name="preguntapf10_1"
                                id="preguntapf10_1">{{ $exist_diagnostico_empresa->preguntapf10_1 }}</p>
                        </div>
                        <!--preguntapf11-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf11"
                                id="preguntapf11">{{ $exist_diagnostico_empresa->preguntapf11 }}</p>
                        </div>
                        <!--preguntapf12-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf12"
                                id="preguntapf12">{{ $exist_diagnostico_empresa->preguntapf12 }}</p>
                        </div>
                        <!--preguntapf13-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf13"
                                id="preguntapf13">{{ $exist_diagnostico_empresa->preguntapf13 }}</p>
                        </div>
                        <!--preguntapf14-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf14"
                                id="preguntapf14">{{ $exist_diagnostico_empresa->preguntapf14 }}</p>
                        </div>
                        <!--preguntapf15-->
                        <div class="alert alert-light">
                            ...
                            <p class="form-control" name="preguntapf15"
                                id="preguntapf15">{{ $exist_diagnostico_empresa->preguntapf15 }}</p>
                        </div>
                    </form>
                </div>
            </div>
