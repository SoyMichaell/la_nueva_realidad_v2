                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="matricula" type="text"
                                        ...
                                        name="matricula" value="{{ old('matricula') }}" autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="organizacion" type="text"
                                        ...
                                        name="organizacion" value="{{ old('organizacion') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="razon_social" type="text"
                                        ...
                                        name="razon_social" value="{{ old('razon_social') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="identificacion" type="text"
                                        ...
                                        name="identificacion" value="{{ old('identificacion') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="fecha_matricula" type="date"
                                        ...
                                        name="fecha_matricula" value="{{ old('fecha_matricula') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="fecha_renovacion" type="date"
                                        ...
                                        name="fecha_renovacion" value="{{ old('fecha_renovacion') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="municipio" type="text"
                                        ...
                                        name="municipio" value="{{ old('municipio') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="telefono1" type="number"
                                        ...
                                        name="telefono1" value="{{ old('telefono1') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="telefono2" type="number"
                                        ...
                                        name="telefono2" value="{{ old('telefono2') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="telefono3" type="number"
                                        ...
                                        name="telefono3" value="{{ old('telefono3') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="correo" type="email"
                                        ...
                                        name="correo" value="{{ old('correo') }}" autofocus>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('correo') }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="ciiu_1" type="text"
                                        ...
                                        name="ciiu_1" value="{{ old('ciiu_1') }}" autofocus>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ciiu_1') }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="ciiu_2" type="text"
                                        ...
                                        name="ciiu_2" value="{{ old('ciiu_2') }}" autofocus>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ciiu_2') }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="ciiu_3" type="text"
                                        ...
                                        name="ciiu_3" value="{{ old('ciiu_3') }}" autofocus>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ciiu_3') }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="correo" type="text"
                                        ...
                                        name="ciiu_4" value="{{ old('ciiu_4') }}" autofocus>
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ciiu_4') }}
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="numero_persona" type="number"
                                        ...
                                        name="numero_persona" value="{{ old('numero_persona') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="activo_total" type="number"
                                        ...
                                        name="activo_total" value="{{ old('activo_total') }}" autofocus>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="representante" type="text"
                                        ...
                                        name="representante" value="{{ old('representante') }}" autofocus>
                                    <div class="invalid-feedback">
